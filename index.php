<?php get_header(); /* Tells WordPress to include header.php */ ?>      
    ...
    <h2>GAMES &amp; LEVEL DESIGNER</h2>
       ...
       <section class="container-fluid articlesbg"> 
            <div class="container">
                <div class="row"> <!-- a row that gives us acess to the BS columns -->
                </div>
        <div>
            <h3 class="text-center artcile-title">LATEST ARTICLES</h3>
                </div>
                
    <div class="col-md-4 article-cent"> 
        <img class="img-responsive" alt=“portait” src="http://206.189.45.97/~mesh4/wp-content/themes/starter_for_josh_site/images/game.jpg">
    <h4>A PORTRAIT</h4>
    ...
    <p>STS has never been shy of seeking new terrains of investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session. We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.  </p>
                ...
                <div class="col-md-4 article-cent">
    <img class="img-responsive" alt=“model” src="http://206.189.45.97/~mesh4/wp-content/themes/starter_for_josh_site/images/game.jpg">
    <h4>A MODEL</h4>
    <p class="date">Friday,November 10. 2019 </p>
    <p>STS has never been shy of seeking new terrains of investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session. We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.  </p>
                ...
                <div class="col-md-4 article-cent"> 
    <img class="img-responsive" alt=“gamedesign” src="http://206.189.45.97/~mesh4/wp-content/themes/starter_for_josh_site/images/game.jpg">
    <h4>GAMES DESIGN</h4>
     <p class="date">Friday,November 10. 2019 </p>
    <p>STS has never been shy of seeking new terrains of investigation. More and  more  STS s cholars are  starting to explore and intervene in the arts.  This object of study  brings  new challenges and  opportunities that we want  to explore in this session. We would  like to gather first of all simply  new kinds of  knowledge arising from  STS study  of the arts.  </p>
